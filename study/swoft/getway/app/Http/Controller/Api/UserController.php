...
class UserController{
    ...
    /**
     * Get one by ID. access uri path: /api/User/{id}
    ...
    /**
     * Create a new record. access uri path: /api/User
    ...
    /**
     * Update one by ID. access uri path: /api/User/{id}
    ...
    /**
     * Delete one by ID. access uri path: /api/User/{id}
